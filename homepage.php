...
<body>
    ...
    <aside class="sidebar">
        <h1>Care</h1>
        <ul>
           <li><button onclick="location.href='recordsystem.php'" id="recordButton" class="buttons">Record System</button></li> 
            <li><button onclick="location.href='blooddonation.html'" id="donationButton" class="buttons">Blood Donation</button></li> 
