...
<body>
    ...
    <main class="container">
        <form id="patientRecordForm" onsubmit="return validateForm()">
              ...
              <div class="textbox-group2">
                 <div class="input-field">
                  ...
                  <div class="textbox-single">
                    <div class="input-field">
                      <input type="text" id="healthstatus" placeholder="Health Status">
                    </div>
                 </div>
    ...
    <script>
        function validateForm() {
            const inputs = document.querySelectorAll('#patientRecordForm input[type="text"]');
