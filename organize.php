...
<body>
    ...
    <form method="POST" action="assign_periods.php"> <!-- action should point to your server-side script that handles the form -->
    ...
    document.getElementById("logoutButton").addEventListener("click", function() {
        if (confirm("Are you sure you want to log out?")) {
            window.location.href = "login1.php"; // Ensure this is correct.
        }
    });
